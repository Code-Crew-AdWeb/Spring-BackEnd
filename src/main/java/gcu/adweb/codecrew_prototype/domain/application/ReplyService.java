...
import gcu.adweb.codecrew_prototype.domain.repository.FindReplyRepositoryImpl;
...
import gcu.adweb.codecrew_prototype.domain.repository.ReplyRepository;
...
public class ReplyService {
    ...
    private FindReplyRepositoryImpl findReplyRepository;

    //댓글 생성
    public ReplyGetResponseDto saveReply(Long memberId,Long postId,ReplySaveRequestDto replySaveRequestDto) {
